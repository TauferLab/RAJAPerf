...
void ARRAY_OF_PTRS::runOpenMPTargetVariant(VariantID vid)
{
...
RAJAPERF_DEFAULT_TUNING_DEFINE_BOILERPLATE(ARRAY_OF_PTRS, OpenMPTarget, Base_OpenMPTarget, RAJA_OpenMPTarget)
