...
#define POLYBENCH_MVT_BODY4_RAJA_LOCAL \
  Real_type dot = 0.0;
...
#ifndef POLYBENCH_MVT_GPU_UNROLL
#define POLYBENCH_MVT_GPU_UNROLL 4
#endif

#define POLYBENCH_MVT_UNROLL \
  RAJAPERF_PRAGMA(unroll POLYBENCH_MVT_GPU_UNROLL)
