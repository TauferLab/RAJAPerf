    ...
    for (RepIndex_type irep = 0; irep < run_reps; RP_REPCOUNTINC(irep)) {
      ...
      RAJA::region<RAJA::seq_region>( [=]() {
        ...
        RAJA::forall<RAJA::omp_target_parallel_for_exec<threads_per_team>>( res,
          RAJA::RangeSegment(ibegin, iend), RAJA::Name("ENERGY_1"), [=](Index_type i) {
          ENERGY_BODY1;
        });

        RAJA::forall<RAJA::omp_target_parallel_for_exec<threads_per_team>>( res,
          RAJA::RangeSegment(ibegin, iend), RAJA::Name("ENERGY_2"), [=](Index_type i) {
          ENERGY_BODY2;
        });

        RAJA::forall<RAJA::omp_target_parallel_for_exec<threads_per_team>>( res,
          RAJA::RangeSegment(ibegin, iend), RAJA::Name("ENERGY_3"), [=](Index_type i) {
          ENERGY_BODY3;
        });

        RAJA::forall<RAJA::omp_target_parallel_for_exec<threads_per_team>>( res,
          RAJA::RangeSegment(ibegin, iend), RAJA::Name("ENERGY_4"), [=](Index_type i) {
          ENERGY_BODY4;
        });

        RAJA::forall<RAJA::omp_target_parallel_for_exec<threads_per_team>>( res,
          RAJA::RangeSegment(ibegin, iend), RAJA::Name("ENERGY_5"), [=](Index_type i) {
          ENERGY_BODY5;
        });

        RAJA::forall<RAJA::omp_target_parallel_for_exec<threads_per_team>>( res,
          RAJA::RangeSegment(ibegin, iend), RAJA::Name("ENERGY_6"), [=](Index_type i) {
          ENERGY_BODY6;
        });
