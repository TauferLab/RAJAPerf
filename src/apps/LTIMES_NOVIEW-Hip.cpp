...
//
#define LTIMES_NOVIEW_M_THREADS_PER_BLOCK_HIP \
  dim3 nthreads_per_block(static_cast<size_t>(num_m), 1, 1);

#define LTIMES_NOVIEW_M_NBLOCKS_HIP \
...
#define LTIMES_NOVIEW_ZGM_THREADS_PER_BLOCK_TEMPLATE_PARAMS_HIP \
  zgm_m_block_sz, zgm_g_block_sz, zgm_z_block_sz

#define LTIMES_NOVIEW_ZGM_THREADS_PER_BLOCK_HIP \
  dim3 nthreads_per_block(LTIMES_NOVIEW_ZGM_THREADS_PER_BLOCK_TEMPLATE_PARAMS_HIP); \
  static_assert(zgm_m_block_sz*zgm_g_block_sz*zgm_z_block_sz == block_size, "Invalid block_size");

#define LTIMES_NOVIEW_ZGM_NBLOCKS_HIP \
