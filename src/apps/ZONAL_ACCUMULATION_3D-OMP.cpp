...
void ZONAL_ACCUMULATION_3D::runOpenMPVariant(VariantID vid)
{
...
RAJAPERF_DEFAULT_TUNING_DEFINE_BOILERPLATE(ZONAL_ACCUMULATION_3D, OpenMP, Base_OpenMP, Lambda_OpenMP, RAJA_OpenMP)
